...
{
public:
	GuiBuilder(sf::RenderWindow& window, ResourceManager& resourceManager
	...
	void createButton(const std::string& buttonName, int layer = 1);
	...
	void createButtonTemplate(const std::string& buttonName, int layer = 1);
...
inline int GuiBuilder::getNewID(const std::string& buttonName)
{
...
inline Button& GuiBuilder::emplaceButton(bool isTemplate, const std::string& buttonName, int templateID)
{
...
inline Button& GuiBuilder::copyButton(Button& old, const std::string& buttonName, int templateID)
{
	int buttonID = getNewID(buttonName);
...
template <class T>
void GuiBuilder::setButton(gui::BtnChar buttonChar, T value)
{
	setButton(lastButton, buttonChar, value);
}
template <class T>
void GuiBuilder::setButton(int buttonID, gui::BtnChar buttonChar, T value)
{
#ifdef DEBUGMODE
...
template <class T>
void GuiBuilder::setButton(const std::string& buttonName, gui::BtnChar buttonChar, T value)
{
#ifdef DEBUGMODE
...
template <class T>
void GuiBuilder::setBtnAtr(gui::BtnAtrChar atrChar, T value)
{
	setBtnAtr(lastButton, lastBtnAtr, atrChar, value);
}
template <class T>
void GuiBuilder::setBtnAtr(int buttonID, const std::string& atrName, gui::BtnAtrChar atrChar, T value)
{
#ifdef DEBUGMODE
	if(getPos(buttonID) == -1)
	{
...
template <class T>
void GuiBuilder::setBtnAtr(const std::string& buttonName, const std::string& atrName, gui::BtnAtrChar atrChar, T value)
{
#ifdef DEBUGMODE
	if(getPos(buttonName) == -1)
	{
...
template <class T>
void GuiBuilder::setGroupAtr(gui::BtnChar buttonChar, T value)
{
	setGroupAtr(lastGroup, buttonChar, value);
}
template <class T>
void GuiBuilder::setGroupAtr(const std::string& groupName, gui::BtnChar buttonChar, T value)
{
#ifdef DEBUGMODE
...
template <class T>
void GuiBuilder::setListAtr(const std::string& listName, gui::BtnChar buttonChar, T value)
{
#ifdef DEBUGMODE
...
inline int GuiBuilder::getPos(const int buttonID)
{
...
template<class String>
inline int GuiBuilder::getPos(String&& name)
{
#ifdef DEBUGMODE
